        ...
        <article class="card-body">
            ...
            <form action="./updateFornecedor.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="codF" name="codF" value="<?php echo $row['codForne'] ?>"><br>
                </div>
                <div class="form-group">
                    <label for="nomeF">Nome Fornecedor</label>
                    <input class="form-control" type="text" id="nomeF" name="nomeF" value="<?php echo $row['nomeForne'] ?>"><br>
                </div>
                <div class="form-group">
                    <label for="contactoF">Contacto Fornecedor</label>
                    <input class="form-control" type="text" id="contactoF" name="contactoF"  value="<?php echo $row['contacForne'] ?>"><br>
                </div>
                <div class="form-group">
                    <label for="emailF">Email Fornecedor</label>
                    <input class="form-control" type="text" id="emailF" name="emailF"  value="<?php echo $row['emailForne'] ?>"><br>
                </div>
                <div class="form-group">
