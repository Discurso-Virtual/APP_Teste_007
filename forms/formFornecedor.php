        ...
        <article class="card-body">    
            ...
            <form action="../inserts/insertFornecedor.php" method="POST" autocomplete="off">
                <div class="form-group">    
                    ...
                    <input class="form-control" type="text" id="nomeF" name="nomeF"><br>
                </div>
                <div class="form-group">
                    <label for="contactoF">Contacto Fornecedor</label>
                    <input class="form-control" type="text" id="contactoF" name="contactoF"><br>
                </div>
                <div class="form-group">
                    <label for="emailF">Email Fornecedor</label>
                    <input class="form-control" type="text" id="emailF" name="emailF"><br>
                </div>
                <div class="form-group">
