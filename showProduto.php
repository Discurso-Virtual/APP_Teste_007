            ...
            <div class="col-lg-8">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" onclick="openModal(<?php echo $row['refProduto'];?>,'<?php echo $currentPage?>', 'Editar')" data-target="#loadModal" data-toggle="modal" >Editar
                        </td>
                        <td>
                            <a href="#" onclick="openModal(<?php echo $row['refProduto'];?>,'<?php echo $currentPage?>', 'Eliminar')" data-target="#loadModal" data-toggle="modal" >Eliminar
                        </td>
